...
@Named
public class MailToTheTechTeam  implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        try {
            ...
            message.addRecipient(Message.RecipientType.TO, new InternetAddress("TechTeam@RandomMail.com"));

            message.setSubject("A new issue is reported [TechTeam]");
